 ...
 * @date 2020/10/24
 * <p>
 * filter_type = 0:popularity, 1:vote_average, 2:first_air_date
...
public class FilterTv {
    ...
    public FilterTv(int filterId, int filterType, int filterOrder, String date, int type, int page, int index) {
